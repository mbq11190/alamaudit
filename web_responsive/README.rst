...
- Redirect to the dashboard after logging in. Users are redirected to
  the home page by default. This behavior can be disabled by
  unchecking the 'Redirect to Home' option in their profile settings.
