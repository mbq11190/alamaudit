...
class AuditDone(models.TransientModel):
    ...
    confirm = fields.Text(
        "Confirm",
        default="Hey, have you made sure to save all the attachments and data in the Google Drive folder? Because once we hit Confirm Button, its bye-bye to those files in the Odoo Database! If you are sure, please click on Confirm otherwise Click Cancel, Save Files and Come back again.",
    )
