...
class AuditStages(models.Model):
    ...
    is_active = fields.Boolean(
        string="Active", default=True, help="Indicates if the stage is active or not."
    )
    # Name of the stage
    name = fields.Char(
        string="Name",
    ...
    description = fields.Text(
        string="Description", translate=True, help="Description of the stage."
    )
    # Sequence to order the stages
    sequence = fields.Integer(
        string="Sequence", default=1, help="Sequence to order the stages."
    )
