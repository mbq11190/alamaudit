"""Simple tests for onboarding hints dictionary. These tests do not require Odoo to be present."""

import importlib.util
import pathlib

spec = importlib.util.spec_from_file_location(
    "qaco_client_onboarding.utils.onboarding_hints",
    pathlib.Path(__file__).resolve().parents[1] / "utils" / "onboarding_hints.py",
)
