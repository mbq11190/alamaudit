...
class AuditArchival(models.Model):
    ...
    archival_date = fields.Date(default=lambda self: fields.Date.context_today(self), tracking=True)
    retention_period = fields.Integer(default=365, help='Retention in days.', tracking=True)
