...
class AuditClientAcceptance(models.Model):
    ...
    generated_letter_id = fields.Many2one('audit.engagement.letter', string='Engagement Letter')
    ...
    def _create_engagement_letter(self):
        ...
        for record in self:
            ...
            values = {
                ...
                'scope_of_audit': record.background_check_notes or _('Scope auto-generated from acceptance memo.'),
