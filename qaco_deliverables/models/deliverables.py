...
class DeliverableKAM(models.Model):
    ...
    description = fields.Html(string='Why it is a KAM?', required=True)
    audit_response = fields.Html(string='Audit Response Summary', required=True)
...
class DeliverableEOM(models.Model):
    ...
    narrative = fields.Html(string='Paragraph Narrative', required=True)
