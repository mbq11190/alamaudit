{
    ...
    "summary": "Zero-deficiency ISA-compliant planning workflow (P-1 to P-12) for statutory audits in Pakistan",
    "version": "17.0.1.0.0",
    "author": "QACO",
    ...
    "price": 0,
    "currency": "PKR",
    "description": "Audit Planning Phase module covering planning tabs P-1 to P-12 (ISA-aligned).",
} 
