...
class PlanningP8GoingConcern(models.Model):
    ...
    fs_basis = fields.Selection([
        ...
        ('other', 'Other'),
    ], string='Financial Statement Basis', default='going_concern')
    assessment_timing = fields.Selection([
        ('planning', 'Planning Stage'),
        ('interim', 'Interim'),
        ('year_end', 'Year-End'),
    ], string='Assessment Timing', default='planning')
    ...
    source_cash_flow_forecasts = fields.Boolean(
        ...
        help='Used cash flow forecasts'
    )
    source_financing_agreements = fields.Boolean(
        string='☐ Financing Agreements',
        help='Reviewed financing agreements'
    )
    source_budgets_plans = fields.Boolean(
        string='☐ Budgets/Business Plans',
        help='Reviewed budgets and business plans'
    )
    ...
    cash_flow_testing_required = fields.Boolean(
        string='Cash Flow Testing Required',
