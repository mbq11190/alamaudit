...
class AuditPlanningP11GroupAudit(models.Model):
    """P-11: Group Audit Planning (ISA 600 Revised) - MASTER MODEL"""
    _name = 'audit.planning.p11.group_audit'
    ...
    def _check_preconditions(self):
        ...
        # Check P-10
        p10 = self.env['audit.planning.p10.related_parties'].search([
        ...
        # Check P-2
        p2 = self.env['audit.planning.p2.entity'].search([
            ('engagement_id', '=', self.engagement_id.id),
            ('audit_year_id', '=', self.audit_year_id.id),
        ], limit=1)
...
# ============================================================================
class AuditPlanningP11Component(models.Model):
    ...
    p11_id = fields.Many2one(
        'audit.planning.p11.group_audit',
...
# ============================================================================
class AuditPlanningP11ComponentRisk(models.Model):
    """Component-Level Risk Assessment"""
    _name = 'audit.planning.p11.component_risk'
...
# ============================================================================
class AuditPlanningP11ComponentAuditor(models.Model):
    """Component Auditor Evaluation"""
    _name = 'audit.planning.p11.component_auditor'
