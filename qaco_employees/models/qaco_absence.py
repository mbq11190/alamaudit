...
class HrEmployee(models.Model):
    ...
    @api.depends('attendance_ids.check_in', 'attendance_ids.check_out', 'attendance_ids.employee_id')
    def _compute_absent_today(self):
        ...
        for record in self:
            ...
            if not employee_attendances_today or all(att.check_out for att in employee_attendances_today):
